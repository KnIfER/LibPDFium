...
OBJS_pdfiumfxge := $(addsuffix .o, $(LOCAL_SRC_FILES))
OBJS_pdfiumfxge := $(addprefix build/$(_ARCH_PX_)/pdfiumfxge/, $(OBJS_pdfiumfxge))
	
libpdfiumfxge.a: $(OBJS_pdfiumfxge)
	$(AR) -rv libpdfiumfxge.a $(OBJS_pdfiumfxge)

build/$(_ARCH_PX_)/pdfiumfxge/%.o: %
	@echo $<; set -x;\
	mkdir -p $(dir $@);\
